...
class UpcomingCommand(Command):
    ...
    def execute(self, slack_wrapper, args, channel_id, user_id):
        ...
        # ...
        api = Twitter(
            auth=OAuth('784778974715076609-TFnbV1HuKOCxqOku7ypDFdbQDkATMde',
                       'MiPiXQnXzR4tbfNl9ImLcGZP2uy4vQMZDmyakgA1kkmdy', 'Bj4K8zPxi5KsSQrkOG5dsgTOt',
                       'fgR4KjHDDSzno2H1JvSLA9dD3O3KkGXSq2mmSdM3uHt20ts5ve'))
