...
class AddCTFCommand(Command):
    ...
    def execute(self, slack_wrapper, args, channel_id, user_id):
        ...
        print("Channel added of ID: {}".format(channel))
        slack_wrapper.set_purpose(channel, purpose, is_private=True)

        # Invite user
        slack_wrapper.invite_user(user_id, channel, is_private=True)
...
class RenameCTFCommand(Command):
    ...
    def execute(self, slack_wrapper, args, channel_id, user_id):
        ...
        response = slack_wrapper.rename_channel(ctf.channel_id, new_name, is_private=True)
        ...
        # Update channel purpose
        slack_wrapper.update_channel_purpose_name(ctf.channel_id, new_name, is_private=True)
...
class JoinCTF(Command):
    def execute(self, slack_wrapper, args, channel_id, user_id):
        ...
        # Invite user to challenge channel
        slack_wrapper.invite_user(
            user_id, ctf_channel.channel_id, is_private=True)
